...
#define DCR_CLOCK			0x03		//resuming from low power mode
#define DCR_OPEN			0x04		//open handle
#define DCR_CLOSE			0x05		//close handle
#define DCR_CANCEL			0x06		//cancel handle operation
#define DCR_SIGNAL			0x07


#define DCR_GET_WAITING		0x08

#define DCR_PARAMS			0x09
#define DCR_ISR				0x0c

#define DCR_STEP			0x0a
#define DCR_STOP			0x0b
#define DCR_WRITE			0x0d
#define DCR_HANDLE			0x0f
#define DCR_BAUDRATE		0x10
#define DCR_CANCEL_ALL		0x11
#define DCR_WAIT			0x12
#define DCR_CONTINUE		0x13
